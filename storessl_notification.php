...
$sslname = $_POST['ssl_name'];
$date      = date("Y/m/d");
$expdate   = date('Y/m/d', strtotime('+1 years'));
$fetch = "INSERT INTO ss_users (`first_name`, `last_name`, `user_mail`,`ssl_name`, `purchase_date`, 'expiry_date`) VALUES ('$firstname','$lastname','$email','$sslname','$date','$expdate')";
...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <tbody>
<?php
$fetchqry = "SELECT * FROM ssl_users";
