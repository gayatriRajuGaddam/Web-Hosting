...
<div class="conntainer" style="width:100%; margin-left:80px; margin-top:20px">	
	<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">   
		<a href="#" style="font-size:25px; text-decoration:none; font-weight:bold;"> User List</a>
		<hr>
        <div class="row">
                <div class="col">
                    <?php
		...
		<div class="panel-heading " style="margin-top:-20px">
			<div class="row">
				<div class="col-md-2" align="right">
                    <a class="btn btn-success" href="add_users.php" style="color:white; width:100%; margin-left:900px; margin-bottom:20px; text-decoration:none">Add</a>
				</div>
			</div>
		</div>
		<table class="table table-bordered table-striped" style="border:1px solid gray; width:100%">
			<thead >
				<tr >
					<th >ID</th>
					<th>First Name</th>
				...
				<tr>
					...
					<td>
                        <a href="view_users.php?user_id=<?php echo $row['id'] ?>" class="btn btn-primary">View</a>
                        <a href="hostedit_account.php?user_id=<?php echo $row['id'] ?>" class="btn btn-success">Edit</a>
