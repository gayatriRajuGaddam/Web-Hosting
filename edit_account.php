                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="user_email" value="<?php echo $data['user_email']; ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="domain_name" value="<?php echo $data['domain_name']; ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
