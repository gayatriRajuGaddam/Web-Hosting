...
<div class="row">
    ...
    <div class="col-10">
        <div class="container" style="width:50%; margin-top:30px;">
            <div class="row">
                <div class="col">
                    <form action="save_sslaccount.php" method="post">
                        <div class="card">
                            <div class="card-header"  style="background:#1C3481; color:white">
                                View Account Details<a href="ssluser_list.php" style="text-decoration:none; color:white; Margin-left:300px">Back</a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
								...
								<div class="row">
                                    <div class="col">
                                        <label for="">SSL - <?php echo $data['ssl_name']; ?></label>
