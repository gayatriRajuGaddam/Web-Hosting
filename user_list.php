...
<div class="conntainer" style="margin-left:40px; ">	
                    ...
                    <div class="panel-heading " style="margin-top:20px">
                        <div class="row">
                            <div class="col-5">
                                ...
                                <div class="progress">
                                   <div class="progress-bar" id="myBar" role="progressbar" aria-valuenow="70"
                                   aria-valuemin="0" aria-valuemax="100" style="width:10%" onclick="myGeeks()">
                                     10%
                                   </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-heading " style="margin-top:-20px">
                        <div class="row">
                            <div class="col-md-2" align="right">
                                <a class="btn btn-success" href="add_domainuser.php" style="color:white; width:100%; margin-left:900px; margin-bottom:20px; text-decoration:none">Add</a>
                            </div>
                        </div>
                    </div>
		
		<table class="table table-bordered table-striped" id="sample_form" style="border:1px solid gray; wisth:100% ">
			<thead style="width:100%">
				...
				<tr>
					...
					<td>
                        <a href="view_domainusers.php?user_id=<?php echo $row['id'] ?>" class="btn btn-primary">View</a>
                        <a href="edit_account.php?user_id=<?php echo $row['id'] ?>" class="btn btn-success">Edit</a>
                        <a href="delete_domain.php?user_id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
                    </td>
