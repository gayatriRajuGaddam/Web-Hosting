    ...
    <body>
        <div class="container">
               <div class="card card-register mx-auto mt-5">
                 ...
                 <div class="card-body">
                        <form action="sslregister_valid.php" method="POST">
                            <div>
                            ...
                            <br>
                            <div>
                                <label>SSL Name</label>
                                <br>
                                <input class="form-control" type="text" name="ssl_name">
                                <br>
                                <small style="color:red;">
                                    <?php echo isset($arrstrFormError['ssl_err'])?$arrstrFormError['ssl_err']:""; ?>
                                </small>
                            </div>
                            <br>
                            <div>
