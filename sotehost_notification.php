...
$query = "INSERT INTO hostusers (`first_name`, `last_name`, `user_mail`,`host_name`, `purchase_date`, 'expiry_date`) VALUES ('$firstname','$lastname','$email','$hostname','$date','$expdate')";
...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <tbody>
<?php
$fetchqry = "SELECT * FROM hostusers";
