...
if(empty($_POST['host_name'] )){
    ...
    $host = filter_var($_POST['host_name'], FILTER_SANITIZE_STRING);
...
if($flag === true){
    ...
    $query = "INSERT INTO hostusers(first_name,last_name,user_email,user_password,host_name,purchase_date,expiry_date) VALUES('$first_name','$last_name','$user_email','$user_password','$host_name','$purchase_date','$expiry_date')";
    ...
    header("Location:hostregister.php"); //redirection
}
