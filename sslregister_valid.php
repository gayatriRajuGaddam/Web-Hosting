...
if(empty($_POST['ssl_name'] )){
    $arrstrError['ssl_err'] = 'ssl Name is required';
    $flag = false;
}
else{
    $mobile = filter_var($_POST['ssl_name'], FILTER_SANITIZE_STRING);
...
if($flag === true){
    ...
    $query = "INSERT INTO ssl_users(first_name,last_name,user_email,user_password,ssl_name,purchase_date,expiry_date) VALUES('$first_name','$last_name','$user_email','$user_password','$ssl_name','$purchase_date','$expiry_date')";
    ...
    header("Location:sslregister.php"); //redirection
}
